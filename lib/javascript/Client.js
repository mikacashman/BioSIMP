...
function BioSIMP(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.BioSIMP = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "BioSIMP.BioSIMP",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "BioSIMP.status",
